...
// ../.wrangler/tmp/bundle-fS5xjn/checked-fetch.js
...
async function onRequestGet({ env, params }) {
  try {
    ...
    const match2 = dataUrl.match(/^data:(image\/[a-zA-Z+]+);base64,(.+)$/);
    if (!match2) {
      return new Response("Invalid image data", { status: 500 });
    }
    const mimeType = match2[1];
    const b64Data = match2[2];
    ...
    if (!hasSlidesSystem) {
      const defaultData = {
        settings: {
          ...
          footerText: "\xA9 2026 Aqueous Portfolio. Created with Widescreen Slides."
        },
        theme: "classicDark",
        pages: [
          {
...
// ../.wrangler/tmp/pages-dRDhTG/functionsRoutes-0.5584491596456076.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-fS5xjn/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-fS5xjn/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.1643604773132763.mjs.map
